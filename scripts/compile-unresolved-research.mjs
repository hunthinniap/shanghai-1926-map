...
const roadNames = new Map([
  ...
  ['CHAPOO ROAD', '乍浦路'],
  ['FEARON ROAD', '九龙路'],
  ['ROUTE DE ZIKAWEI', '徐家汇路／肇嘉浜路（分段）'],
  ['ROUTE DE SAY-ZOONG', '常熟路'],
  ['ROUTE CASSINI', '泰康路'],
  ['HANKOW ROAD', '汉口路'],
  ...
  ['KOOKA LUNG', '顾家弄'],
  ['KUNGPING ROAD', '公平路'],
  ['ROUTE CARDINAL MERCIER', '茂名南路'],
  ['MEDHURST ROAD', '泰兴路'],
  ['WUTSIN', '武进路'],
  ['MANDALAY ROAD', '江阴路'],
  ['RACE COURSE ROAD', '武胜路'],
  ['CHIHTSAO ROAD', '制造局路'],
  ['HWEINING', '徽宁路'],
  ['HSIAZI', '肇嘉浜路／斜徐路（残段）'],
  ['ZHONGXING', '中兴路'],
  ['RANGE ROAD', '武进路'],
  ['ROUTE LAFAYETTE', '复兴中路'],
  ['ROUTE PERE ROBERT', '瑞金二路'],
  ['ICHANG ROAD', '宜昌路'],
  ['CHANGCHUN LU', '长春路'],
  ['DALIAN (XI)', '大连西路'],
  ['PAOTING ROAD', '保定路'],
  ['NORTH YANGTSE ROAD', '扬子路／扬子江路（门牌沿革）'],
  ['KIAOCHOW ROAD', '胶州路'],
  ['SHANYIN', '山阴路'],
  ['ZHENGBEN', '政本路'],
])
