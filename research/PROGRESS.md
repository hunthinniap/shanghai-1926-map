...
- [2026-09-11-current-020-d2077a11](external/2026-09-11-current-020-d2077a11/manifest.json)：50 条，研究日期 2026-09-11；[原评审](external/2026-09-11-current-020-d2077a11/review.md)，[本项目补充评审](external/2026-09-11-current-020-d2077a11/supplemental-review.json)。
  本轮有限检索完成 44 条、部分完成 6 条、未开始 0 条。
  原报告结论：verified 1 条、likely 5 条、unresolved 44 条；回填建议：yes 0 条、review 6 条、no 44 条。
  本项目优先补证 ID：1569、691、1565、1062、1355、574、204、1712。

## 当前文件与调查记录对照

| 当前文件 | 条数 | 有调查记录 | 已分配、无结果 | 已停放 utility | 未调查、未分配 |
|---|---:|---:|---:|---:|---:|
| [001.json](../public/data/unresolved-landmarks/001.json) | 50 | 50 | 0 | 0 | 0 |
...
| [009.json](../public/data/unresolved-landmarks/009.json) | 50 | 50 | 0 | 0 | 0 |
| [010.json](../public/data/unresolved-landmarks/010.json) | 50 | 50 | 0 | 0 | 0 |
